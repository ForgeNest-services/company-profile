// SEO Utilities for Forgenest Services
...
export function generateMetadata(config: SEOConfig) {
  ...
  return {
    title: title.includes('Forgenest') ? title : `${title} | Forgenest Services`,
    description,
    keywords,
    authors: author ? [{ name: author }] : [{ name: 'Forgenest Services Team' }],
...
export function generateOrganizationSchema() {
  return {
    ...
    description: 'Leading IT solutions provider in Nepal specializing in custom software development, web applications, and digital transformation.',
    foundingDate: '2021',
    contactPoint: {
      '@type': 'ContactPoint',
...
export function generateWebsiteSchema() {
  return {
    ...
    potentialAction: {
      '@type': 'SearchAction',
      target: 'https://www.forgenestservices.com.np/search?q={search_term_string}',
...
export function generateLocalBusinessSchema() {
  return {
    ...
    name: 'Forgenest Services Pvt. Ltd.',
    image: 'https://res.cloudinary.com/dpnhdq9eg/image/upload/v1756144318/Primary_RGB_kwha6h.png',
    url: 'https://www.forgenestservices.com.np',
    telephone: '+977-1-XXXXXXX',
    address: {
      '@type': 'PostalAddress',
